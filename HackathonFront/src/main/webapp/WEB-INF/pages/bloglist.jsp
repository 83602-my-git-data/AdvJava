...
<body>
	<div class="container">
		<jsp:useBean id="blog" class="com.app.beans.BlogListBeans"
			...
			<tbody>
				<c:forEach var="c" items="${blog.blogList}">
					<tr>
						...
						<td><c:choose>
								<c:when test="${c.userId == login.user.userId}">
									<button>
										<a href="ctl?page=delete&id=${c.id}"> Delete </a>
									</button>
								</c:when>
								<c:otherwise>
									<button>
		...
		<div class="actions">
			<a href="ctl?page=MyBLogs">My Blogs</a> <a href="ctl?page=AddBLogs">Add
				Blogs</a> <a href="ctl?page=signout">Sign Out</a>
		</div>
	</div>
</body>
</html>
